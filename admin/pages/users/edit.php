                        ...
                        <label class="custom-control-label w-100" for="customRadioInline1">
                            <div>
                                <div class="p-3 bg-white rounded shadow-sm w-100">
                                    ...
                                    <p class="small text-muted m-0" id="full-address">
                                    
                                        <?php 
                                        
                                            echo $data['street'] . ' ' . $d->getaddress(["cities" => $data['city'], "states" => $data['state'], "countries" => $data['country']]);
                                         ?>
                                    </p>
                                    ...
                                    <p class="pt-2 m-0 text-right"><span class="small"><a href="#" data-toggle="modal"
                                        ...
                                        <span class="small ml-3"><a href="#" data-toggle="modal" data-target="#Delete"
                                                class="text-decoration-none text-danger"><i class="icofont-trash"></i>
                                                Delete</a></span>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                            ...
                            <form class="">
                                <div class="form-row">
                                        ...
                                        <div class="input-group form-inline">
                                            ...
                                            <div class="input-group-append"><button id="button-addon2" type="button"
                                                    class="btn btn-outline-secondary"><i
                                                        class="icofont-pin"></i></button></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-group"><label class="form-label">Street Address </label>
                                        <input class="form-control" name="street" id="street" data-live-search="true"
                                            placholder="Street Address" value="<?= $user['street'] ?>">
                                    </div>
                        ...
                        <div class="modal-footer p-0 border-0">
                            ...
                            <div class="col-6 m-0 p-0">
                                <button type="button" onclick="saveaddress('<?= $user['ID']; ?>')"
                                    class="btn btn-success btn-lg btn-block">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
